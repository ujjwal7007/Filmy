    ...
    <section class="text-gray-300 body-font relative">
      <div class="container px-5 py-8 mx-auto">
        <div class="flex flex-col text-center w-full mb-4">
          <h1 class="sm:text-3xl text-xl font-medium title-font mb-4 text-cyan-500 hover:text-teal-600">
            Add Movies
          </h1>
        </div>
        <div class="lg:w-1/2 md:w-2/3 mx-auto">
          <div class="flex flex-wrap -m-2">
            ...
            <div class="p-2 w-full">
              <button
                onClick={addMovie}
                class="flex mx-auto text-white bg-cyan-500 border-0 py-2 px-8 focus:outline-none hover:bg-cyan-700 rounded-md text-lg"
              >
                {loading ? <Triangle height={25} color="white" /> : "Submit"}
              </button>
            </div>
          </div>
        </div>
